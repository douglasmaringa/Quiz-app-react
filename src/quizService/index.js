const qBank = [
  {
    question:
      "Which vehicle is used by class 2 driving student",
    answers: ["Obama", "Alan Sugar", "Donald Trump", "Bill Gates"],
  ...
  },
  {
    ...
    answers: ["Octopus", "Lion", "Whale", "Shark"],
    correct: "Octopus",
    questionId: "3"
  },
  {
    ...
    correct: "Helen of Troy",
    questionId: "4"
  },
  {
    question: "What is the Italian word for pie?",
    answers: ["Pizza", "Pizzera", "Pizzara", "Pie"],
    correct: "Pie",
    questionId: "5"
  }
  ,
  {
    ...
    answers: ["Runners", "Water Skiers", "Soccer Players", "Footballers"],
